"""
Create a fresh, working stage1_integrated.py file
Run this if you're having encoding or other issues
"""
...
if os.path.exists('stage1_integrated.py'):
    shutil.copy('stage1_integrated.py', 'stage1_integrated_OLD.py')
    print("✅ Backed up old file to stage1_integrated_OLD.py")
...
try:
    ...
    print("WARNING: Make sure all Stage 1 files are in the same directory!")
...
class Stage1IntegratedSystem:
    ...
    def __init__(self, watch_paths=None, log_dir="./data/logs"):
        ...
        if os.path.exists('ransomware_model.pkl'):
            ...
            print("   WARNING: No pre-trained model found. Training new model...")
        ...
        print("\\nALL DONE Stage 1 system initialized successfully!")
    ...
    def _train_initial_model(self):
        ...
        print("   ALL DONE Initial model trained on 230 samples")
    ...
    def start(self):
        ...
        print("\\nMonitoring:")
        print(f"  FILES Files: {', '.join(self.watch_paths)}")
        print(f"  HONEY Honeypots: ./honeypots")
        print(f"  COMPUTER Processes: All system processes")
        ...
        try:
            while self.is_running:
                ...
                if analysis['threat_level'] in ['HIGH', 'CRITICAL']:
                    print(f"  WARNING  {analysis['suspicious_processes']} suspicious processes")
                    print(f"  WARNING  {analysis['recent_file_events']} recent file events")
    ...
    def stop(self):
        ...
        print("ALL DONE Stage 1 system stopped")
...
print("\n" + "="*70)
print("✅ CREATED FRESH stage1_integrated.py")
print("="*70)
...
print("\n✅ This file includes ALL fixes:")
print("  • Idle detection")
print("  • [IDLE] status display")
print("  • Proper numpy import")
print("  • Fixed analyze_current_state()")